...
//   Float_t aaft[14] = {294.0,295.0,306.5,292.0,269.0,281.0,297.0,276.0,287.0,327.0,319.0,284.0,300.0,342.0};  // ADC after
  ...
  TH1F *mdf = new TH1F("mdf","Comparison of Mean ADCs - PMT1",15,0,15);
  mdf->SetMaximum(2000.0);
  mdf->SetMinimum(0.0);
  mdf->SetStats(0);
  ...
  lgto->AddEntry(g1, "run 1994: without resistors", "P");
  lgto->AddEntry(g2, "run 1999: optimized resistors", "P");
