...
void plotL_ML(Int_t runno, Int_t n_events=-1){
...
TCanvas *plot_adc_fit(Int_t pmt=1, Int_t tdc_min=750, Int_t tdc_width=400, Int_t adc_neighbor_cut=40, Int_t adc_cut=40){
	...
	Int_t nbin=90;
	Int_t min=-100, max=2000; // change max to 1500 for PMT 9
