...
void sfi_ts_pedsup_br2_3__init (rolp)
     rolParam rolp;
{
...
{	long *StartOfBank; StartOfBank = (rol->dabufp); *(++(rol->dabufp)) = ((( 6 ) << 16) | ( 0x01 ) 
