/* # 1 "/home/adaq/crl/sfi_ts_pedsup_br3_1.c" */
...
void sfi_ts_pedsup_br3_1__init (rolp)
     rolParam rolp;
{
...
/* # 6 "/home/adaq/crl/sfi_ts_pedsup_br3_1.c" 2 */
...
/* # 7 "/home/adaq/crl/sfi_ts_pedsup_br3_1.c" 2 */
/* # 1 "/home/adaq/crl/GEN_source.h" 1 */
...
/* # 23 "/home/adaq/crl/GEN_source.h" 2 */
extern int tiDoAck;
void
GEN_int_handler()
{
...
/* # 8 "/home/adaq/crl/sfi_ts_pedsup_br3_1.c" 2 */
/* # 1 "/home/adaq/crl/sfi.h" 1 */
/* # 1 "/home/adaq/crl/usrstrutils.c" 1 */
...
/* # 1 "/home/adaq/crl/sfi.h" 2 */
/* # 1 "/home/adaq/crl/threshold.c" 1 */
/* # 1 "/home/adaq/crl/evmacro.h" 1 */
/* # 3 "/home/adaq/crl/threshold.c" 2 */
...
/* # 2 "/home/adaq/crl/sfi.h" 2 */
/* # 10 "/home/adaq/crl/sfi_ts_pedsup_br3_1.c" 2 */
...
void titrig(unsigned long EVTYPE,unsigned long EVSOURCE)
{
    long EVENT_LENGTH;
  {   
unsigned long dCnt, ev_type, ii, datascan, res, jj, fbres, numLocal, numBranchdata, syncFlag;   *sfi.sequencerEnable = 0;
  rol->dabufp = (long *) 0;
{ 
{
  if(1 ==1)
...
\n",dCnt, numLocal, ev_type, numBranchdata, syncFlag, tibready); 	  if (nb %100 == 0)
...
*(rol->nevents));	}	((rol->dabufp))++;} ; { 
{
  if(1 ==1)
    {
{	long *StartOfBank; StartOfBank = (rol->dabufp); *(++(rol->dabufp)) = ((( 1 ) << 16) | ( 0x01 ) 
...
{	long *StartOfBank; StartOfBank = (rol->dabufp); *(++(rol->dabufp)) = ((( 2 ) << 16) | ( 0x01 ) 
...
{ 
  ...
  if (fbres) logMsg("fbres = 0x%x\n",fbres,0,0,0,0,0);
  if ((datascan != 0) && (datascan&~scan_mask)) {
logMsg("Error: No data found but More data available after readout datascan = 0x%08x fbres = 
0x%x\n",datascan,fbres,0,0,0,0);  }
 } 
    {*(rol->dabufp)++ = ( datascan );} ; 
    {*(rol->dabufp)++ = ( ii );} ; 
