...
void sfi_ts_pedsup_br3_4_test__init (rolp)
     rolParam rolp;
{
...
/* # 6 "sfi_ts_pedsup_br3_4_test.c" 2 */
...
/* # 7 "sfi_ts_pedsup_br3_4_test.c" 2 */
/* # 1 "GEN_source.h" 1 */
...
/* # 8 "sfi_ts_pedsup_br3_4_test.c" 2 */
/* # 1 "sfi.h" 1 */
/* # 1 "usrstrutils.c" 1 */
...
void set_thresholds()
{
  ...
  for(imodule=0;imodule<nmodules;imodule++){
	...
	temp = 0;
	 ...
	 temp = thresholds[imodule][ichan]+1000;
      fpwc(padr,sadr,temp);
      sfi_error_decode(0);
    }
  }
...
/* # 2 "sfi.h" 2 */
/* # 10 "sfi_ts_pedsup_br3_4_test.c" 2 */
