...
struct ps_numbers {
  ...
  unsigned short psn[15]; /* Property summary numbers  */
...
struct ccrate
{
  ...
  unsigned short gstatus[2]; /* general status words */
  unsigned short hwstatus;   /* hardware status word */
  int hvstatus;              /* crate HV status:1- ON, 0 - OFF */
...
*/
  ...
  unsigned short gsn[5];  /* Global summary numbers */
  unsigned short lsn[20]; /* Logical summary numbers */
