...
int main(int argc, char* argv[])
{
  ...
  tree_adc->Branch("value"	          ,tree_adc_hits, tempstr);
  tree_adc->Branch("pedestal"        ,&tree_adc_pedestal_chan,     "pedestal/I");
  ...
  tree_tdc->Branch("value"		  ,tree_tdc_hits, tempstr);
