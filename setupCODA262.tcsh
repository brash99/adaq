...
setenv PATH ${AFECS_HOME}/bin:${JAVA_HOME}/bin:/site/coda/2.6.2/Linux/bin:/site/coda/2.6.2/common/bin:/usr/lib/qt-3.3/bin:/usr/local/bin:/bin:/usr/bin:/opt/puppetlabs/bin
...
setenv ANALYZER /home/adaq/analyzer
setenv REPLAY /home/adaq/analyzer/replay
setenv DB_DIR $ANALYZER/DB
setenv DATA_DIR /home/adaq/data
setenv OUT_DIR $REPLAY/rootfiles

setenv PATH ${ANALYZER}/apps:${PATH}
setenv LD_LIBRARY_PATH ${ANALYZER}:${ANALYZER}/SDK:${LD_LIBRARY_PATH}
