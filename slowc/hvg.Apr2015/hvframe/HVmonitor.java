 ...
 *              28-Apr-15, add 'status' variable and  getStatus() method to check state of monitor from HVframe.load()
 */             
...
public class HVmonitor extends Thread implements Cmd {
    ...
    private int status = 0; //** 28 Apr 2015: state of thread: 0-suspended or sleep; 1-running. Used in HVframe.load()
